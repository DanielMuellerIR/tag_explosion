...
tagx_require_notary_profile() {
    ...
    # Keychain password item found", obwohl das Profil da ist (2026-07-26 auf einem
    # Entwicklungs-Mac belegt — Versuch 1 fehlgeschlagen, Versuch 2 sofort ok). Ein einzelner
