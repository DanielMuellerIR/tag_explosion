...
- Der Bewertungstest verwendet das echte Binding des Bild-Batch-Editors.
  Die nachgebaute Setter-Logik und ein dadurch redundanter Test entfallen;
  gemischte Werte, Löschen und geänderte Puffer bleiben geprüft.
...
- Der Online-Matcher bereitet Titel einmal vor und verwendet die Zeichenlisten
  für alle Vergleiche wieder. Eine Messung mit 300 Dateien und 300 Titeln
  sinkt bei bytegleichen Zuordnungen von 300 auf 73 ms.
- Unabhängige Lookup-CLI-Tests laufen parallel.
...
- Prozess-Abbruchtests teilen die Bereitschaftsabfrage anhand der gestarteten
  PID. Beim unbegrenzt laufenden Werkzeug ersetzt die Prüfung auf tatsächliche
  Beendigung eine knappe Zwei-Sekunden-Annahme.
...
- E-Book-, Dokument- und Playlist-Schreibwege ordnen Fehler temporärer
  Kopien über eine gemeinsame Funktion der Originaldatei zu. Neue
  Fehlerarten werden zentral beim Fehlertyp berücksichtigt.
...
- Die ZIP-Längenprüfung berücksichtigt die abschließende Deflate-Anfrage
  am Dateiende. Große komprimierte Einträge lassen sich wieder schreiben;
  unerwartet kurze Datenblöcke bleiben ein Fehler.
