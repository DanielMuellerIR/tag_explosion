...
struct EbookToolTests {
    ...
    @Test("azw3: Roundtrip via ebook-meta")
    func azw3Roundtrip() throws {
        guard EbookTool.calibreAvailable,
              FileManager.default.fileExists(
                  atPath: Fixtures.directory.appendingPathComponent("book.azw3").path) else {
            return // Calibre nicht installiert — Format wird dann nicht angeboten
        }
