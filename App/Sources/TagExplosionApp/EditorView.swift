    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 20) {
                ...
                // Video mit `<name>.nfo` daneben: Kodi-/Jellyfin-Felder; der
                // Puffer liegt im Eintrag und wird mit ihm gespeichert.
                if entry.videoNFO != nil {
                    NFOSidecarSection(entry: entry)
                }
